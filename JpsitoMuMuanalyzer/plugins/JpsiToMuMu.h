#ifndef __JPSITOMUMU_H
#define __JPSITOMUMU_H
...
histoarg hist_arg[Histnamesize]={
  ...
  {"h_mumumass", "#mu^{+}#mu^{-} invariant mass; M(#mu^{+}#mu^{-}) [GeV/c^{2}]",100,1.,10.},
  //  {"h_pv","primary vertex",50,0.,50.},
  {"h_jpsivtxcl",  "#mu^{+}#mu^{-} vertex CL", 100, 0., 1.},

  {"h_jpsismass","J\#psi invariant mass",100,1.,4.},
};

TH1F *histos[Histnamesize];
// class declaration                                                                                                                                          

class JpsiToMuMu : public edm::EDAnalyzer{
   public:
     explicit JpsiToMuMu(const edm::ParameterSet&);
     ~JpsiToMuMu();
  ...
  bool hasGoodMuMuVertex (const reco::TransientTrack, const reco::TransientTrack, reco::TransientTrack &, reco::TransientTrack &, double &, double &, double &, double &, double &, double &, double &, double &);
